...
mod tests {
    ...
    fn test_accrue_rewards_no_change() {
        ...
        let result = user_reward_info.accrue_rewards(&reward_info, 1000, 18);
        assert!(result.is_ok());
    ...
    fn test_accrue_rewards_with_delta() {
        ...
        let user_balance = 1_000_000_000_000_000_000u64; // 1 token
        let result = user_reward_info.accrue_rewards(&reward_info, user_balance, 18);
    ...
    fn test_accrue_rewards_overflow_case() {
        ...
        let result = user_reward_info.accrue_rewards(&reward_info, 1_000_000u64, 6);
        assert!(result.is_ok());
    }
    ...
    fn test_calculate_and_update_accrued_rewards() {
        ...
        let delta = U256::from(1_000_000);

        let user_balance = 1_000_000_000u64; // 1000 tokens with 6 decimals
        let result = user_reward_info.calculate_and_update_accrued_rewards(user_balance, delta, 6);
    ...
    fn test_calculate_and_update_accrued_rewards_zero_balance() {
        ...
        let result = user_reward_info.calculate_and_update_accrued_rewards(0, delta, 18);
        assert!(result.is_ok());
        assert_eq!(user_reward_info.accrued_rewards, 0);
    }
    ...
    fn test_calculate_and_update_accrued_rewards_overflow() {
        ...
        let result = user_reward_info.calculate_and_update_accrued_rewards(u64::MAX, delta, 18);
        assert!(result.is_err());
        assert_eq!(result.unwrap_err(), MathOverflow.into());
    }

    #[test]
    fn test_calculate_and_update_accrued_rewards_different_decimals() {
        let mut user_reward_info = setup_user_reward_info();
        let delta = U256::from(100);

        let balance_6 = 1_000_000u64; // 1 token in 6 decimals
        let result_6_decimals =
            user_reward_info.calculate_and_update_accrued_rewards(balance_6, delta, 6);
        assert!(result_6_decimals.is_ok());
        let rewards_6_decimals = user_reward_info.accrued_rewards;

        user_reward_info.accrued_rewards = 0;
        let balance_18 = 1_000_000_000_000_000_000u64; // 1 token in 18 decimals
        let result_18_decimals =
            user_reward_info.calculate_and_update_accrued_rewards(balance_18, delta, 18);
        assert!(result_18_decimals.is_ok());
        let rewards_18_decimals = user_reward_info.accrued_rewards;

        assert_ne!(rewards_6_decimals, rewards_18_decimals);
    }
    ...
    fn test_calculate_and_update_accrued_rewards_accumulation() {
        ...
        let user_balance = 1_000_000_000u64; // 1000 tokens with 6 decimals
        let result1 = user_reward_info.calculate_and_update_accrued_rewards(user_balance, delta, 6);
        assert!(result1.is_ok());
        let first_rewards = user_reward_info.accrued_rewards;

        let result2 = user_reward_info.calculate_and_update_accrued_rewards(user_balance, delta, 6);
